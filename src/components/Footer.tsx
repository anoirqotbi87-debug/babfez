      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed">{dict.footer?.slogan}</p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href={`/${lang}/#services`} className="hover:text-amber-500 transition-colors">{dict.services?.f3Title}</a></li>
              <li><a href={`/${lang}/#services`} className="hover:text-amber-500 transition-colors">{dict.services?.f2Title}</a></li>
              <li><a href={`/${lang}/#services`} className="hover:text-amber-500 transition-colors">{dict.services?.f1Title}</a></li>
              <li><a href={`/${lang}/#simulateur`} className="hover:text-amber-500 transition-colors text-amber-600 font-medium">{dict.nav?.estimateBtn}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href={`/${lang}`} className="hover:text-amber-500 transition-colors">{dict.nav?.home || 'Accueil'}</Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500 border-t border-slate-800 pt-8 pb-12 md:pb-0">
          <div className="flex gap-4">
            <Link href={`/${lang}/admin/login`} className="opacity-40 hover:opacity-100 hover:text-amber-500 transition-all font-bold" title="Administration">{dict.footer?.admin || '🔒 Admin'}</Link>
            <Link href={`/${lang}/mentions-legales`} className="hover:text-amber-500 transition-colors">{dict.footer?.legal}</Link>
            <Link href={`/${lang}/confidentialite`} className="hover:text-amber-500 transition-colors">{dict.footer?.privacy}</Link>
            <Link href={`/${lang}/conditions-generales`} className="hover:text-amber-500 transition-colors">{dict.footer?.tos}</Link>
          </div>
